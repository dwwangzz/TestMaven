...
public class FileUtil {
	 ...
	 * @param path 文件路径
	 * @param output 字符输出流
	 * @throws java.io.IOException 读取失败，发生IO异常
	 */
	 ...
	 * 根据文件或目录的绝推路径 获取目录
	 * 如：
	 * 1./dir1/dir2/a.jpg 返回/dir1/dir2
	 * 2./dir2/dir2/dir3/ 返回/dir2/dir2/dir3
	 * 3./dir2/dir2/dir3 返回/dir2/dir2 #因为会把dir3识别成文件名，入过需要把他识别成目录，用2的方式
	 * @param path
	 * @return
	 */
	 ...
	 * 根据文件或目录的绝推路径 文件名
	 * 如：
	 * 1./dir1/dir2/a.jpg 返回 "a.jpg"
	 * 2./dir2/dir2/dir3/ 返回 ""
	 * 3./dir2/dir2/dir3 返回 "dir3" #因为会把dir3识别成文件名，入过需要把他识别成目录，用2的方式
	 * @param path
	 * @return
	 */
	...
	public static void main(String[] args) {
		String path1 = "/aaa/bbb/ccc/ddd/1.jpg";
		String path2 = "/aaa/bbb/ccc/ddd";

		//System.out.println(getNameByPath(path1));
		System.out.println(getDirByPath(path2));
